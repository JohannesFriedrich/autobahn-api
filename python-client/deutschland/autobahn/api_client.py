...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_charging_station  # this is an instance of the class Endpoint
        api_instance.get_charging_station()  # this invokes api_instance.get_charging_station.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_charging_station.callable or self.callable in this class
